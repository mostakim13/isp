                        ...
                        <div class="row">
                            <div class="col-md-6 mb-1">
                                ...
                                <select class="select2 form-control assetlist" onchange="assetQty()" name="asset_id">
                                    ...
                                    <option qty="{{$asset->qty}}" value="{{$asset->id}}" {{ $asset->id ==
                                        $editinfo->asset_id ? 'selected':''
                                        }}>{{$asset->name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-1">
                                ...
                                <select class="select2 form-control" name="reason_id">
                                    ...
                                    <option value="{{$reason->id}}" {{ $reason->id == $editinfo->reason_id ?
                                        'selected':'' }}>{{$reason->reason_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-6 mb-1">
                            ...
                            <div class="col-md-6 mb-1">
                                ...
                                <input type="date" class="form-control input-rounded" name="destroy_date"
                                    placeholder="Destroy Date" value="{{$editinfo->destroy_date}}">
                            </div>
                            <div class="col-md-6 mb-1">
                                <label for=""> Remarks</label>
                                <input type="text" class="form-control input-rounded" name="remarks"
                                    placeholder="Remarks" value="{{$editinfo->remarks}}">
                            </div>
                        </div>

                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <input type="text" class="form-control input-rounded" name="m_rate_limite_rx"
                                    value="{{ old('m_rate_limite_rx') ?? ($editinfo->m_rate_limite_rx ?? '')}}"
                                    placeholder="RX">
                            </div>
                            <div class="col-md-6 mb-3">
                                <input type="text" class="form-control input-rounded" name="m_rate_limite_tx"
                                    value="{{ old('m_rate_limite_tx') ?? ($editinfo->m_rate_limite_tx ?? '')}}"
                                    placeholder="TX">
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <input type="text" class="form-control input-rounded" name="m_burst_rate_rx"
                                    value="{{ old('m_burst_rate_rx') ?? ($editinfo->m_burst_rate_rx ?? '')}}"
                                    placeholder="RX">
                            </div>
                            <div class="col-md-6 mb-3">
                                <input type="text" class="form-control input-rounded" name="m_burst_rate_tx"
                                    value="{{ old('m_burst_rate_tx') ?? ($editinfo->m_burst_rate_tx ?? '')}}"
                                    placeholder="TX">
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <input type="text" class="form-control input-rounded" name="m_burst_threshold_rx"
                                    value="{{ old('m_burst_threshold_rx') ?? ($editinfo->m_burst_threshold_rx ?? '')}}"
                                    placeholder="RX">
                            </div>
                            <div class="col-md-6 mb-3">
                                <input type="text" class="form-control input-rounded" name="m_burst_threshold_tx"
                                    value="{{ old('m_burst_threshold_tx') ?? ($editinfo->m_burst_threshold_tx ?? '')}}"
                                    placeholder="TX">
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <input type="text" class="form-control input-rounded" name="m_burst_time_rx"
                                    value="{{ old('m_burst_time_rx') ?? ($editinfo->m_burst_time_rx ?? '')}}"
                                    placeholder="RX">
                            </div>
                            <div class="col-md-6 mb-3">
                                <input type="text" class="form-control input-rounded" name="m_burst_time_tx"
                                    value="{{ old('m_burst_time_tx') ?? ($editinfo->m_burst_time_tx ?? '')}}"
                                    placeholder="TX">
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <input type="text" class="form-control input-rounded" name="m_min_rate_rx"
                                    value="{{ old('m_min_rate_rx') ?? ($editinfo->m_min_rate_rx ?? '')}}"
                                    placeholder="RX">
                            </div>
                            <div class="col-md-6 mb-3">
                                <input type="text" class="form-control input-rounded" name="m_min_rate_tx"
                                    value="{{ old('m_min_rate_tx') ?? ($editinfo->m_min_rate_tx ?? '')}}"
                                    placeholder="TX">
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <select name="m_priority"
                                    value="{{ old('m_priority') ?? ($editinfo->m_priority ?? '')}}"

...
class RoleController extends Controller
{
     ...
     * @param RoleService $systemService
     * @param GeneralTransformer $systemTransformer
     */
    public function __construct(RoleService $roleServices, GeneralTransformer $generalTransformer)
    {
        $this->systemService = $roleServices;
        $this->systemTransformer = $generalTransformer;
    }

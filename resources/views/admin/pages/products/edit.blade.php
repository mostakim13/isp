                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-1">
                                ...
                                <select class="form-control" id="single-select" name="product_category_id">
                                    ...
                                    <option {{$editinfo->product_category_id == $value->id ? "selected":""}}
                            ...
                            <div class="col-md-6 mb-1">
                                ...
                                <select class="form-control js-example-disabled" name="unit_id">
                                    ...
                                    <option {{$editinfo->unit_id == $value->id ? "selected":""}}
                                        value="{{$value->id}}">{{$value->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 mb-1">
                                ...
                                <input type="text" class="form-control" value="{{ $editinfo->purchases_price}}"
                                    name="purchases_price" placeholder="Purchases Price">
                            </div>

                            <div class="col-md-6 mb-1">
                                <label for="">Sale Price <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" value="{{ $editinfo->sale_price}}"
                                    name="sale_price" placeholder="Sale Price">
                            </div>

                            <div class="col-md-6 mb-1">
                                <label for="">Low Stock</label>
                                <input type="text" class="form-control" value="{{ $editinfo->low_stock }}"
                                    name="low_stock" placeholder="Low Stock">
                            </div>
                        </div>

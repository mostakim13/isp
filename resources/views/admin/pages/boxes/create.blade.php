                ...
                <div class="basic-form">
                    <form action="{{ $store_url ?? '#' }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-1">
                                <label for="">Available Cores for Box</label>
                                <select class="form-control" name="box_core_id" id="box_core_id">
                                    <option selected disabled>Select Option</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 mb-1">
                                ...
                                <input type="text" class="form-control input-rounded" value="{{old('core')}}"

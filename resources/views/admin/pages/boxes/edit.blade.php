                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-4 mb-1">
                                ...
                                <select class="form-control" name="splitter_id" id="splitter_id">
                                    ...
                                    <option value="{{$value->id}}" {{$value->id == $editinfo->splitter_id ? 'selected' : ''}}>{{$value->name}}
                                        ({{$value->remain}})</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-4 mb-1">
                                ...
                                <select class="form-control" name="box_id" id="box_id">
                                    <option selected disabled>Select Option</option>
                                    @foreach($boxes as $value)
                                    <option value="{{$value->id}}" {{$value->id == $editinfo->box_id ? 'selected' : ''}}>{{$value->name}} ({{$value->remain}})</option>
                                    @endforeach
                                </select>
                            </div>
